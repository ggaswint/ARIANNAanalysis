...
def main():
	...
	np.save(PathToARIANNAanalysis + '/data/SPICE_Dec30_2018_EFieldDataLPDA/cc_lpdas_stn51',[times,angles])

	times, angles = printHeaderDetailsPerEvent(file,((4, 6), (5, 7)))
	np.save(PathToARIANNAanalysis + '/data/SPICE_Dec30_2018_EFieldDataLPDA/cc_dipoles_stn51',[times,angles])
