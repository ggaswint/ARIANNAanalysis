...
def plotPolarization():
	...
	fig.tight_layout()
	fig.savefig(PathToARIANNAanalysis + '/data/polReco.png')
	fig.savefig(PathToARIANNAanalysis + '/data/polReco.pdf')

	fig2.tight_layout()
	fig2.savefig(PathToARIANNAanalysis + '/data/polRecoHist.png')
	fig2.savefig(PathToARIANNAanalysis + '/data/polRecoHist.pdf')
